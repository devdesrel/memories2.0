...
class UploadFilesPage extends StatelessWidget {
  ...
  UploadFilesPage({this.bloc, this.event});
//   @override
          ...
          items: [
            ...
            BottomNavigationBarItem(
                title: Text(
                    ...
                    style: TextStyle(color: Colors.black)),
                icon:
                    Icon(Icons.cloud_upload, color: Colors.black, size: 35.0)),
            BottomNavigationBarItem(
                title: Text(
                    // "Photos".toUpperCase(),
                    "",
                    style: TextStyle(color: Colors.black)),
                icon: Icon(Icons.camera_alt, color: Colors.black, size: 35.0)),
            BottomNavigationBarItem(
                title: Text(
                    // "Videos".toUpperCase(),
                    "",
